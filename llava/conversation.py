...
llama3_tok = AutoTokenizer.from_pretrained("/mnt/lzy/models/llama3-llava-next")
...
class Conversation:
    ...
    def get_prompt(self):
        ...
        if self.sep_style == SeparatorStyle.SINGLE:
            ...
            # print(self.tokenizer.apply_chat_template(chat_template_messages, tokenize=False, add_generation_prompt=True))
...
conv_llava_llama_3 = Conversation(
    ...
    tokenizer_id="/apdcephfs_jn/share_302244400/peterrao/nj3/models/Llama-3-8B-Instruct",
    tokenizer=safe_load_tokenizer("/apdcephfs_jn/share_302244400/peterrao/nj3/models/Llama-3-8B-Instruct"),
